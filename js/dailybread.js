...
//    if (tdAry[1][0][1] == 0){ return }
    if (tdAry ==null || tdAry[1][0][1] == 0){ return }	//ODL ueda [ 2014/09/18 17:39 ] ***********************************************************
    //console.log(tdAry);
  ...
  this.drawIcons = function(t) {
    ...
    $('.db-area-icon', t).each(function(i,e) {
      ...
      paper.circle(iconRad,iconRad,iconRad).attr({ fill: '#009140', stroke: 'none' });
...
OpenSpending.renderDependentTypes = function(db) {
  function draw(iconPath, target, selected) {
    ...
    r.circle(iconRad,iconRad,iconRad).attr({ fill: '#009140', stroke: 'none' });
